...
type PullRequestsViewerPullRequestsNodesMergeQueueEntry struct {
	PullRequest *PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequest
}

type PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequest struct {
	Commits PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequestCommits
}

type PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequestCommits struct {
	Nodes *PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequestCommitsNodes
}

type PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequestCommitsNodes []*struct {
	Commit PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequestCommitsNodesCommit
}

type PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequestCommitsNodesCommit struct {
	Oid               string
	MessageHeadline   string
	MessageBody       string
	StatusCheckRollup *PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequestCommitsNodesCommitStatusCheckRollup
}

type PullRequestsViewerPullRequestsNodesMergeQueueEntryPullRequestCommitsNodesCommitStatusCheckRollup struct {
	State StatusState
}
...
// AssignableUsers from github/githubclient/queries.graphql:56
...
// CreatePullRequest from github/githubclient/queries.graphql:76
...
// UpdatePullRequest from github/githubclient/queries.graphql:89
...
// AddReviewers from github/githubclient/queries.graphql:101
...
// CommentPullRequest from github/githubclient/queries.graphql:113
...
// MergePullRequest from github/githubclient/queries.graphql:123
...
// AutoMergePullRequest from github/githubclient/queries.graphql:135
...
// ClosePullRequest from github/githubclient/queries.graphql:147
...
// StarCheck from github/githubclient/queries.graphql:159
...
// StarGetRepo from github/githubclient/queries.graphql:175
...
// StarAdd from github/githubclient/queries.graphql:184
